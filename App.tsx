                        ...
                        {result ? (
                            <div className="space-y-4">
                                <div className="flex items-center bg-black/20 backdrop-blur-sm p-1 rounded-xl border border-white/20">
                                    <button 
                                        ...
                                        className={`w-1/2 py-2 px-4 text-sm font-bold rounded-lg transition-all duration-300 ${reportView === 'summary' ? 'bg-white/20 text-white' : 'text-gray-300 hover:bg-white/10'}`}>
                                        <i className="fas fa-chart-pie mr-2"></i>Resumen de Rentabilidad
                                    </button>
                                    <button 
                                        onClick={() => setReportView('details')}
                                        className={`w-1/2 py-2 px-4 text-sm font-bold rounded-lg transition-all duration-300 ${reportView === 'details' ? 'bg-white/20 text-white' : 'text-gray-300 hover:bg-white/10'}`}>
                           ...
                           <div className="h-full flex items-center justify-center p-8 bg-black/20 backdrop-blur-xl border border-white/20 rounded-2xl shadow-lg">
                               <div className="text-center text-gray-300">
                                   <i className="fas fa-house-flag text-6xl text-gray-400 mb-4"></i>
                                   <h2 className="text-2xl font-semibold text-white">Esperando análisis</h2>
                                   <p className="mt-2 text-gray-300">Completa los datos y haz clic en "Actualizar".</p>
                               </div>
                           </div>
                        )}
                    </div>
